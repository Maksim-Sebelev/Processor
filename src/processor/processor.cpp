...
// struct Register
// {
//     CharRegister_t   cr[CHAR_REGISTERS_QUANT];
//     IntRegister_t    ir[INT_REGISTERS_QUANT];
//     DoubleRegister_t dr[DOUBLE_REGISTERS_QUANT];
// };

// //--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

// typedef int    IntRegister_t;
// typedef char   CharRegister_t;
// typedef double DoubleRegister_t;
